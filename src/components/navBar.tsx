...
export default function NavBar() {
  return (
    <>
      <div
        className="flex w-full fixed justify-center items-center text-center mt-1 z-50"
       
      >
        <div className="flex items-center pr-2 justify-content-around shadow-6 px-3 mt-2 border-round-2xl"  style={{
